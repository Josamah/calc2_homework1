...
class Calculator:
    ...
    def get_result_of_first_calculation_added_to_history():
        """get first result of calculation"""
        return Calculator.history[0].getResult()

    @staticmethod
    def clear_history():
        """this is to clear history"""
    ...
    def get_result_of_last_calculation_added_to_history():
        # -1 gets the last item added to the list automatically and
        # you can expect it to have the get
        # result method
    ...
    def subtract_number(value_a, value_b):
        ...
        # subtraction = Subtraction(value_a,value_b) <-this is not good but will work.
    ...
    def multiply_numbers(value_a, value_b):
        ...
        # this is a shorthand way to create the multiplication object and
        # added it history in one line
